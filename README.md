...
![Hotel advertising workflow: verify, build, check, publish, measure](assets/booking-workflow.svg)
...
![Budget example showing average versus daily billed cost limit](assets/budget-example.svg)
